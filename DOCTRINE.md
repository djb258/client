...
|----------|---------|----------|
| **ARCHITECTURE.md** | CTB Constitutional Law (CTB, CC, Hub-Spoke, IMO, Descent) | imo-creator/templates/doctrine/ |
...
**Note**: ARCHITECTURE.md (v2.0.0) consolidates CANONICAL_ARCHITECTURE_DOCTRINE.md, HUB_SPOKE_ARCHITECTURE.md, and ALTITUDE_DESCENT_MODEL.md.
